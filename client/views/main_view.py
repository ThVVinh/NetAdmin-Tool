...
class MainView(tk.Tk):
    def __init__(self):
        ...
        self.btnTat.place(x=118, y=133, width=48, height=57)

        self.btnReg = tk.Button(self, text="Sửa registry")
        self.btnReg.place(x=118, y=196, width=198, height=65)
        ...
        self.btnScreenshot.place(x=173, y=133, width=91, height=57)
        
        self.btnKeyLock = tk.Button(self, text="Keystroke")
        self.btnKeyLock.place(x=269, y=64, width=100, height=126)
